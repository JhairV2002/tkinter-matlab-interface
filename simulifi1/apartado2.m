...
print('SINR_con_cooperación_vista1','-dpng')
...
print('SINR_con_cooperación_vista2','-dpng')
close
...
% Primera imagen: Vista desde el ángulo predeterminado (por ejemplo, 30 grados)
view(30, 30); % Establecer vista (azimut, elevación)
print('Rate_con_cooperación_vista1','-dpng')
...
axis equal; % Igualar escala de los ejes x, y, z
print('Rate_con_cooperación_vista2','-dpng')
close
